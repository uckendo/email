<?php
include('connect.php');
if($_GET['action'] == 'del' && !empty($_GET['MessageID'])){
    $MessageID= trim($_GET['MessageID']);
    $query_del = mysql_query("delete from `message` where `MessageID`='$MessageID' limit 1");
                        ...
                        ?>
                            ...
                            <tr>
                               ...
                               <td class="description">
                                ...
                                <td>
									<ul class="actions">
                                        <li><a href='<?=$now_script?>?action=edit&MessageID=<?=$info['MessageID']?>'><i class="table-edit" title='编辑'></i></a></li>
                                        <li class="last"><a href="<?=$now_script?>?action=del&MessageID=<?=$info['MessageID']?>" onclick='return confirm("确认删除？")'><i class="table-delete" title='删除' ></i></a></li>
                                    </ul>
                                </td>
                            </tr>
                            <?php
